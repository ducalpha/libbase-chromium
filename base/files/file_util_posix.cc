...
// ducalpha: remove unnecessary include
// #include "base/memory/singleton.h"
// ducalpha: remove dependency on PathService which depends on LazyInitializer
...
// ducalpha: reduce dependency on sys_info
...
// ducalpha: remove dependency on content_uri_utils which depends on jni
