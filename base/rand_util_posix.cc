...
// ducalpha: remove dependency on LazyInitializer
...
void RandBytes(void* output, size_t output_length) {
  // ducalpha: remove dependency on LazyInitializer
  // const int urandom_fd = g_urandom_fd.Pointer()->fd(); // orig
  URandomFd urandom_fd_obj;
  const int urandom_fd = urandom_fd_obj.fd();
  const bool success =
